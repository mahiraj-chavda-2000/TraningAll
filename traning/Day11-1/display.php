...
if(isset($_POST['change'])){
    $getpage =  $_POST['Page'];
    // echo $getpage;
   $num_results_on_page = (int)$getpage;
    // echo $newpage;
    // echo gettype( $num_results_on_page);
}
...
<body>
    ...
    <form action="" method="post" class="mb-3">
        ...
        <input type="submit" name="change" vlaue="Choose options">
    </form>
    ...
    <?php 
        ...
        if(isset($_POST['delete'])){
            ...
            $deleteUser = "DELETE FROM `usertable` WHERE `usertable`.`id` = $deleteid";
            mysqli_query($mysqli,$deleteUser);
            }
        }
        ...
        <table>
            ...
            <tbody>
                ...
                <tr id='tr_<?= $items['id']; ?>'>
                    ...
                    <td><input type='checkbox' name='delete[]' value='<?= $items['id']; ?>'></td>
                </tr>
                <?php
                                            }
                                            goto a;
